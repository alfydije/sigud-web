...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h4 class="content-header-title mb-0">Laporan / Laporan Stok Barang</h4>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
       ...
       printButton.addEventListener("click", function() {
           Swal.fire({
               ...
               printWindow.document.write('<h4>Laporan Stok Barang</h4>'); // Tambahkan teks laporan
   ...
   function createPDF() {
       var doc = new jsPDF();
       doc.text("Laporan Stok Barang", 10, 10);
